...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.bg_x1 = (self.display_width / 2) - (621 / 2)
        self.bg_x2 = (self.display_width / 2) - (621 / 2)
        self.bg_y1 = 0
        self.bg_y2 = -600
        self.bg_speed = 3
        self.count = 0
    ...
    def run_car(self):
        ...
        while not self.crashed:
            ...
            for event in pygame.event.get():
                ...
                if (event.type == pygame.KEYDOWN):
                    if (event.key == pygame.K_LEFT):
                        if (self.car_x_coordinate>110):
                            self.car_x_coordinate -= 50
                        print ("CAR X COORDINATES: %s" % self.car_x_coordinate)
                    if (event.key == pygame.K_UP):
                        self.bg_speed+=1
                    if (event.key == pygame.K_DOWN and self.bg_speed>=0 and self.enemy_car_speed>=0):

                        self.enemy_car_speed-=1

                    if (event.key == pygame.K_RIGHT):
                        if (self.car_x_coordinate < 610):
                            self.car_x_coordinate += 50
                        print ("CAR X COORDINATES: %s" % self.car_x_coordinate)
            ...
            if self.enemy_car_starty > self.display_height:
                ...
                self.enemy_car_startx = random.randrange(110, 620)
            ...
            if self.car_x_coordinate < 100 or self.car_x_coordinate > 620:
                self.crashed = True
                self.display_message("Game Over !!!")
